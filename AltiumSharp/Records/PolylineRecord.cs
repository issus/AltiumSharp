...
namespace AltiumSharp.Records
{
    ...
    public class PolylineRecord : SchPrimitive
    {
        ...
        public override void ImportFromParameters(ParameterCollection p)
        {
            ...
            LineStyle = (LineStyle)p["LINESTYLE"].AsIntOrDefault();
            StartLineShape = (LineShape)p["STARTLINESHAPE"].AsIntOrDefault();
            EndLineShape = (LineShape)p["ENDLINESHAPE"].AsIntOrDefault();
        ...
        public override void ExportToParameters(ParameterCollection p)
        {
            ...
            p.Add("LINESTYLE", (int)LineStyle);
            p.Add("STARTLINESHAPE", (int)StartLineShape);
            p.Add("ENDLINESHAPE", (int)EndLineShape);
