...
/// <summary>
/// Data transfer object representing a schematic polygon record.
/// Record type 7 in Altium schematic files.
/// Polygons are defined by a series of vertices (X1,Y1), (X2,Y2), etc.
/// </summary>
[AltiumRecord("7")]
internal sealed partial record SchPolygonDto
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the number of vertices in the polygon.
    /// Vertex coordinates are stored as X1, Y1, X2, Y2, etc.
    /// </summary>
    [AltiumParameter("LOCATIONCOUNT")]
    public int LocationCount { get; init; }

    // Note: Vertex coordinates (X1, Y1, X1_FRAC, Y1_FRAC, X2, Y2, etc.) are dynamic
    // and handled separately by the serialization logic based on LocationCount.
    // The following properties provide the first few vertices for common cases.
    ...
    /// <summary>
    /// Gets or sets the unique identifier for this polygon.
    /// </summary>
